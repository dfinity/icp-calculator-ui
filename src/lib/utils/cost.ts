...
export class Cost {
    ...
    public label(): string {
        switch (this.category) {
            case Category.Canister: return "Canister";
            case Category.ExecutionCall: return "Execution:Call";
            case Category.ExecutionHeartbeat: return "Execution:Heartbeat";
            case Category.ExecutionIngress: return "Execution:Ingress";
            case Category.ExecutionTimer: return "Execution:Timer";
            case Category.Storage: return "Storage";
            case Category.NetworkCall: return "Network:Call";
            case Category.NetworkIngress: return "Network:Ingress";
            case Category.HttpOutcall: return "HttpOutcall";
        }
        return "";
    }
    ...
    public cost(days: number): Amount {
        switch (this.kind) {
            case Kind.OneTime: return this.amount;
            case Kind.PerDay: {
                return {
